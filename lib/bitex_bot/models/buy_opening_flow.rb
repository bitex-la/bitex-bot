module BitexBot
  ...
  class BuyOpeningFlow < OpeningFlow
    ...
    def self.transaction_class; Bitex::Buy; end

    def self.transaction_order_id(transaction); transaction.bid_id; end

    def self.order_class; Bitex::Bid; end

    def self.value_to_use
      store.buying_amount_to_spend_per_order || Settings.buying.amount_to_spend_per_order
    end

    def self.profit; store.buying_profit || Settings.buying.profit; end
