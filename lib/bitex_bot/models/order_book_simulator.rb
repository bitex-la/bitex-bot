module BitexBot
  ...
  class OrderBookSimulator
    class << self
      ...
      def run(volatility, transactions, order_book, amount_target, quantity_target)
      ...
      def estimate_quantity_to_skip(volatility, transactions)
      ...
      def best_price?(volume, target, seen)
        volume >= (target - seen)
      end

      def best_price(currency, target, price)
