...
describe BitexBot::OpeningAsk do
  ...
  describe '#finalise' do
    ...
    context 'with executing status' do
      ...
      let(:order) { BitexBot::Exchanges::Order.new('1', :ask, 400, 2, Time.now.to_i, order_status, double) }
  ...
  describe '#order' do
    ...
    let(:order) { BitexBot::Exchanges::Order.new('1', :ask, 400, 2, Time.now.to_i, :status, double) }
