...
describe BitexBot::BuyClosingFlow do
  ...
  describe '.fx_rate' do
    ...
    context '#fx_rate' do
      subject(:instance_rate) { create(:buy_closing_flow).fx_rate }
    ...
    context 'with open positions' do
      ...
      context 'enough order size for taker' do
        ...
        before(:each) do
          ...
          allow(BitexBot::Robot).to receive_message_chain(:taker, :place_order).with(:sell, 2, 10).and_return(BitexBot::ApiWrappers::Order.new('65'))
        end
  ...
  describe '#sync_positions' do
    ...
    context 'with active flows' do
      ...
      context 'with close positions' do
        ...
        let(:order) { BitexBot::ApiWrappers::Order.new('245') }
          ...
          context 'and enough order size' do
            before(:each) do
              ...
              allow(BitexBot::Robot)
                ...
                .and_return(BitexBot::ApiWrappers::Order.new('8787'))
            end
